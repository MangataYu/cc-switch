...
- [x] **Step 1: Write failing schema unit tests**
...
- [x] **Step 3: Implement the minimal schema adapter**
...
- [x] **Step 4: Run GREEN and regress capability tests**
...
- [x] **Step 1: Write failing registry compilation tests**
...
- [x] **Step 3: Implement built-in compilation and immutable indexes**
...
- [x] **Step 4: Add RED tests for stability and collisions**
...
- [x] **Step 5: Implement minimal collision/stability behavior and run GREEN**
...
- [x] **Step 1: Write failing full built-in round-trip matrix**
...
- [x] **Step 3: Implement non-stream restoration**
...
- [x] **Step 4: Add RED rejection tests**
...
- [x] **Step 5: Implement minimal rejections and run GREEN**
...
- [x] **Step 1: Write failing dynamic-tool tests**
...
- [x] **Step 3: Implement deterministic dynamic naming**
...
- [x] **Step 1: Write failing preparation/mode tests**
...
- [x] **Step 3: Implement request integration and richer shadow comparison**
...
- [x] **Step 1: Write failing stream restoration tests**
...
- [x] **Step 3: Implement the smallest restoration hook**
...
- [x] **Step 4: Wire handlers and run GREEN**
...
- [x] **Step 3: Implement evidence recording**
...
- [x] **Step 1: Upgrade fixture expectations and run RED**
...
- [x] **Step 2: Implement bridge replay**
...
- [x] **Step 1: Dispatch independent code review**
...
- [x] **Step 2: Fix every Critical and Important finding with TDD**
...
- [x] **Step 3: Re-dispatch independent verification review**
...
- [x] **Step 4: Run final acceptance exactly**
...
- [x] **Step 5: Audit artifacts and scope**
...
- [x] **Step 6: Update status and commit documentation**
...
- [x] **Step 7: Verify clean final state**
